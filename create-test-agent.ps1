...
$agentId = Run-Command -name "create-agent" -command "node $createAgentScriptPath" -workingDir "D:\mcp\nexus"
...
$benchmarkResult = Run-Command -name "benchmark-agent" -command "node $benchmarkAgentScriptPath" -workingDir "D:\mcp\nexus"
...
$improvements = Run-Command -name "check-improvements" -command "node $checkImprovementsScriptPath" -workingDir "D:\mcp\nexus"
