...
const AGENT_TYPES = [
  ...
  { id: 'data', name: 'Data Analysis Agent' },
 ...
 * Displays a list of agents and allows creating, editing, and deleting agents
 */
const Agents = () => {
  ...
  const startAgentMutation = useMutation({
    mutationFn: agentApi.startAgent,
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['agents'] });
    }
  });
            ...
            <Grid item xs={12}>
              <FormControl fullWidth required>
                ...
                >
                  ...
                  <MenuItem value="document-analysis">Document Analysis</MenuItem>
