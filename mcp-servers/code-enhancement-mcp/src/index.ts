  ...
  try {
    ...
    try {
      ...
      availableModels = response.data.models
        ...
        .filter((name: string) => name.toLowerCase().includes('code') || name.toLowerCase().includes('starcoder'));
...
// Tool handlers
async function handleGenerateCode(req: express.Request, res: express.Response) {
...
async function handleRefactorCode(req: express.Request, res: express.Response) {
...
async function handleAnalyzeCode(req: express.Request, res: express.Response) {
