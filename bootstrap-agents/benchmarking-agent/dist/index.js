...
const BenchmarkingAgent_1 = require("./BenchmarkingAgent");
...
async function main() {
    try {
        ...
        const agent = new BenchmarkingAgent_1.BenchmarkingAgent(nexusClient, adapterManager, agentCommunication, {
            ...agentConfig,
        ...
        bootstrap_core_1.logger.info('Benchmarking Agent is running. Press Ctrl+C to stop.');
        // Handle process termination
        process.on('SIGINT', async () => {
            bootstrap_core_1.logger.info('Stopping Benchmarking Agent...');
            await agent.stop();
            process.exit(0);
        });
    }
